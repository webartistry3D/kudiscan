        ...
        <div className="max-w-4xl mx-auto text-center w-full">
          ...
          <div className="max-w-5xl mx-auto mb-8">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-4">
              {/* Step 1: Snap */}
              <div className="flex flex-col items-center text-center bg-process-card border border-transparent rounded-xl p-3 w-48 h-32 process-card-1">
              ...
              {/* Step 2: Track */}
              <div className="flex flex-col items-center text-center bg-process-card border border-transparent rounded-xl p-3 w-48 h-32 process-card-2">
                <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center mb-2">
              ...
              {/* Step 3: Report */}
              <div className="flex flex-col items-center text-center bg-process-card border border-transparent rounded-xl p-3 w-48 h-32 process-card-3">
                <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center mb-2">
              ...
              {/* Step 4: Scale */}
              <div className="flex flex-col items-center text-center bg-process-card border border-transparent rounded-xl p-3 w-48 h-32 process-card-4">
                <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center mb-2">
